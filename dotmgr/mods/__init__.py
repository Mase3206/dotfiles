...
try:
    ...
    if e.name == 'dotmgr':
        print('Unable to find dotmgr module. This is likely the result of an unset (or improperly set) PYTHONPATH variable. Run `export PYTHONPATH=".:$PYTHONPATH"` to fix this.')
        exit(1)
    else:
        raise
